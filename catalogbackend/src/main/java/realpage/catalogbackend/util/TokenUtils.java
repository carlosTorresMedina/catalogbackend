...
/**
 *
 *Class used to manage the creation and validations of tokens
 *
...
public class TokenUtils  {
    ...
    private final String secret = "d1i9c2y7q3m4o6v5y77ds59yud7s8w26k5h7f98c1s3c";
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser().setAllowedClockSkewSeconds(clockSkew).setSigningKey(secret).parseClaimsJws(token)
                .getBody();
    }
